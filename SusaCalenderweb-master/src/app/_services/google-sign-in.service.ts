...
export class GoogleSignInService {
  ...
  private loginSuccessUrl = ' https://susacalender.el.r.appspot.com/auth/login/success';



  getLoginSuccessData(): Observable<any> {
    return this.http.get(this.loginSuccessUrl);
  }
